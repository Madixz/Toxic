...
tg_sendinfo "<code>I am gonna merge staging into Bot_Sinick</code>"
cd
...
git push --force origin staging:Bot_Sinick
tg_sendinfo "<code>I have merged all commits from staging into Bot_Sinick</code>"

...
from userbot import Message, userbot
from userbot.utils import clean_obj
...
@register(outgoing=True, pattern=r"^\.gcstart (.*)")
...
@register(outgoing=True, pattern=r"^\.gcend (.*)")
...
@register(outgoing=True, pattern=r"^\.gcinv (.*)")
...
@register(outgoing=True, pattern=r"^\.gcinfo (.*)")
...
@register(outgoing=True, pattern=r"^\.gctitle (.*)")
...
@register(outgoing=True, pattern=r"^\.gcunmute (.*)")
...
@register(outgoing=True, pattern=r"^\.gcmute (.*)")
